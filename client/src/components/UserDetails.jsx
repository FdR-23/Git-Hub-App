...
const UserDetails = () => {
    ...
    return (
        <div className='m-auto flex flex-col h-screen'>
            <div>
                <p>User Details <span>{login}</span></p>
                <Link to='/'>back Home</Link>
            </div>

            <div className='block m-auto p-2  border-black bg-zinc-100 border-2 rounded-xl w-80 sm:w-96  '>
                <div className=' '>
